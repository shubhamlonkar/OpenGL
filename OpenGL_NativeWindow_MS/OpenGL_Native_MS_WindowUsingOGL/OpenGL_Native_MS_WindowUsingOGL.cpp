...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE FreeProcInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	HWND hwnd;
	MSG msg;
	TCHAR szClassName[] = TEXT("OpenGL Fixed Function Pipeline By Native Windowing : Window Using OpenGL");
	bool bDone = false;
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szClassName,
		TEXT("OpenGL Fixed Function Pipeline by Native Windowing: Window Using OpenGL"),
