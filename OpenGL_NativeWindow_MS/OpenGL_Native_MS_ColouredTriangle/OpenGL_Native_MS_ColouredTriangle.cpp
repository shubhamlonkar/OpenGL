...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	HWND hwnd;
	MSG msg;
	TCHAR szClassName[] = TEXT("OpenGL Fixed Function Pipeline By Native Windowing:Coloured Triangle");
	bool bDone = false;
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
						szClassName,
						TEXT("OpenGL Fixed Function Pipeline By Native Windowing:Coloured Triangle"),
